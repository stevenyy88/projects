...
I'm Steve Ng from Singapore and the Founder and CEO of Digital Futures Consultancy LLP.

### Software Engineer | Cybersecurity Specialist | AI Innovator

I am a technical builder focused on the intersection of **Artificial Intelligence**, **Cybersecurity**, and **SaaS Development**. My work bridges the gap between high-level business strategy (Lean Canvas, BMD) and technical implementation, with a recent focus on agentic workflows and on-device AI.
